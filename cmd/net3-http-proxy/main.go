...
func main() {
	...
	http.HandleFunc("/", getRequestAndForwardHandler(net3HttpProxyTargetHost, net3HttpProxyTargetPort))
...
func getRequestAndForwardHandler(targetHost, targetPort string) func(res http.ResponseWriter, req *http.Request) {
	return func(res http.ResponseWriter, req *http.Request) {
		...
		targetUrl, err := url.Parse(targetHost + ":" + targetPort)
		if err != nil {
			log.SetOutput(os.Stderr)
